            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    var order = new Order
                    {
                        ...
                        ProductName = product.ProductName, // Assuming Product has a Name property
                    ...
                    var orderMessage = new
                    {
                        ...
                        CustomerName = customer.Username, // Changed to use Username instead of Name + Surname
                        ProductName = product.ProductName, // Assuming Product has a Name property
        ...
        public async Task<IActionResult> UpdateOrderStatus(string id, string newStatus)
        {
            try
            {
                ...
                var statusMessage = new
                {
                    OrderId = order.OrderId,
                    CustomerId = order.CustomerId,
                    CustomerName = order.Username, // Using Username instead of Name + Surname
